...
def main():
    ...
    erp_rows = [
        ...
        {"invoice_id": "INV-1008", "amount": 950.00, "currency": "USD", "customer_name": "Theta Co", "date": "2026-08-08"},
        ...
        {"invoice_id": "INV-1010", "amount": 600.00, "currency": "USD", "customer_name": "Iota LLC", "date": "2026-08-10"},
    ]
    ...
    bank_rows = [
        ...
        {"invoice_id": "INV-1008", "amount": "$950.00", "currency": "USD", "customer_name": "Theta Co", "date": "2026-08-08"},
        # 10. Invalid Monetary Format in External
        {"invoice_id": "INV-1010", "amount": "ERROR123", "currency": "USD", "customer_name": "Iota LLC", "date": "2026-08-10"},
    ]
